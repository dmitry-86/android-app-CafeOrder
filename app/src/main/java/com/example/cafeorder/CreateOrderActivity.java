...
public class CreateOrderActivity extends AppCompatActivity {
    ...
    public void onClickChangeDrink(View view) {
        RadioButton button = (RadioButton) view; // полуили нажатую кнопку
        int id = button.getId(); //ид данной кнопки
        if(id == R.id.radioButtonTea) { //если нажата чай,
            drink = getString(R.string.tea); //то напиток - значение стринг - чай
    ...
    public void onClickSendOrder(View view) {
        builderAdditions.setLength(0);//очищаем сринг билдер
